...
const initialState = {
  ...
  ownPaymentObj: [
    {
      name: "dashboard.acc.payment.Directbanktransfer",
      des: "dashboard.acc.payment.DBT_des",
      enable: false,
    },
    {
      name: "dashboard.acc.payment.Checkpayments",
      des: "dashboard.acc.payment.Checkpayments_des",
      enable: false,
    },
    {
      name: "dashboard.acc.payment.Cashondelivery",
      des: "dashboard.acc.payment.Cashondelivery_des",
      enable: false,
    },
  ],
  bubPaymentObj: [
    ...
    {
      icon: "",
      name: "dashboard.acc.payment.PayPalStandard",
      des: "dashboard.acc.payment.PayPalStandard_des",
      enable: true,
    },
    {
      icon: "",
      name: "dashboard.acc.payment.CreditCard",
      des: "dashboard.acc.payment.CreditCard_des",
      enable: false,
    },
    {
      icon: "",
      name: "dashboard.acc.payment.Stripe",
      des: "dashboard.acc.payment.Stripe_des",
      enable: false,
    },
  ],
};
      ...
      <div className={styles.paymentMethod_container}>
        <div className={styles.paymentMethod_section}>
          <div className={styles.paymentMethod_section_title_container}>
            <div className={styles.paymentMethod_section_title_icon}>
              <img src="/img/Dashboard/entypo_circle-with-cross.svg"></img>
            </div>
            <div className={styles.paymentMethod_section_title_tra}>
              <img src="/img/Dashboard/Polygon_5.svg"></img>
            </div>
            <div className={styles.paymentMethod_section_title}>
              {t("dashboard.acc.payment.no")}
            </div>
            <div className={styles.paymentMethod_section_title_switch}>
              <IOSSwitch
                checked={this.state.noPayment}
                onChange={this.handleChangeNoPayment}
                name="noPayment"
              />
            </div>
          </div>
        ...
        <div className={styles.paymentMethod_section}>
          <div className={styles.paymentMethod_section_title_container}>
            <div className={styles.paymentMethod_section_title_icon}>
              <img src="/img/Dashboard/ic_sharp-payments.svg"></img>
            </div>
            <div className={styles.paymentMethod_section_title_tra}>
              <img src="/img/Dashboard/Polygon_5_blue.svg"></img>
            </div>
            <div className={styles.paymentMethod_section_title}>
              {t("dashboard.acc.payment.own")}
            </div>
            <div className={styles.paymentMethod_section_title_switch}>
              <IOSSwitch
                checked={this.state.ownPayment}
                onChange={this.handleChangeOwnPayment}
                name="own"
              />
            </div>
            <div className={styles.paymentMethod_section_title_des}>
              {t("dashboard.acc.payment.own_exp")}
            </div>
          </div>
        ...
        <div className={styles.paymentMethod_section}>
          <div className={styles.paymentMethod_section_title_container}>
            <div className={styles.paymentMethod_section_title_icon}>
              <img src="/img/Dashboard/ri_secure-payment-fill.svg"></img>
            </div>
            <div className={styles.paymentMethod_section_title_tra}>
              <img src="/img/Dashboard/Polygon_5_blue.svg"></img>
            </div>
            <div className={styles.paymentMethod_section_title}>
              {t("dashboard.acc.payment.bubble8up")}
            </div>
            <div className={styles.paymentMethod_section_title_switch}>
              <IOSSwitch
                checked={this.state.bubPayment}
                onChange={this.handleChangeBubPayment}
                name="bubble8up"
              />
            </div>
            <div className={styles.paymentMethod_section_title_des}>
              {t("dashboard.acc.payment.bubble8up_exp")}
            </div>
          </div>
        ...
        <div className={styles.paymentMethod_update_bt}>
          <Button classes={{ root: styles.paymentMethod_update }}>
            {t("common.upload")}
          </Button>
        </div>
      </div>
