        ...
        <div className={styles.account_tab_container}>
          <Tabs
            ...
            classes={{
              ...
              flexContainer: styles.account_tabsList,
            }}
          >
            ...
            <Tab
              ...
              icon={
                <div onClick={this.test} className={styles.account_down_icon}>
                  <img
                    src={
                      this.state.currentBoard == "companyInfo"
                        ? "/img/Dashboard/Polygon_5_blue.svg"
                        : "/img/Dashboard/Polygon_5.svg"
                    }
                  ></img>
                </div>
              }
            ...
            <Tab
              ...
              icon={
                <div onClick={this.test} className={styles.account_down_icon}>
                  <img
                    src={
                      this.state.currentBoard == "paymentMethod"
                        ? "/img/Dashboard/Polygon_5_blue.svg"
                        : "/img/Dashboard/Polygon_5.svg"
                    }
                  ></img>
            ...
            <Tab
              ...
              icon={
                <div onClick={this.test} className={styles.account_down_icon}>
                  <img
                    src={
                      this.state.currentBoard == "productScheme"
                        ? "/img/Dashboard/Polygon_5_blue.svg"
                        : "/img/Dashboard/Polygon_5.svg"
                    }
                  ></img>
            ...
            <Tab
              ...
              icon={
                <div onClick={this.test} className={styles.account_down_icon}>
                  <img
                    src={
                      this.state.currentBoard == "setting"
                        ? "/img/Dashboard/Polygon_5_blue.svg"
                        : "/img/Dashboard/Polygon_5.svg"
                    }
                  ></img>
            ...
            <Tab
              ...
              icon={
                <div onClick={this.test} className={styles.account_down_icon}>
                  <img
                    className={styles.account_more_icon}
                    src={
                      this.state.currentBoard == "more"
                        ? "/img/Dashboard/more.svg"
                        : "/img/Dashboard/more.svg"
                    }
                  ></img>
                </div>
