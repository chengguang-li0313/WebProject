...
function Stafftag(props: Props) {
  ...
  const rowlist = [
    {
      msg: { type: "count", item: 2 },
      ava: { item: "/img/Dashboard/staff_test.svg", type: "img" },
      Name: { item: "Tom Williams", type: "string" },
      Position: { item: "Client Manager", type: "string" },
  ...
  const [filterList, setFilterList] = React.useState([
    { column: "Staff(NEW)", ope: "Contains", val: "", logicOpe: "and" },
  ]);
